...
namespace Prokl\RequestLogBundle\Service;
 ...
 * @package Prokl\RequestLogBundle\Service
 */
class ResponseLogger
{
    /**
     ...
     *
     * @throws ErrorSerializeResponseException Когда не получилась сериализация response.
     */
    public function logResponse(Request $request, Response $response)
    {
        ...
        try {
            ...
            throw new ErrorSerializeResponseException(
                'Error serialializing response: ' . $e->getMessage(),
                400
            );
        }
